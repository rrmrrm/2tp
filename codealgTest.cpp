...
/// @brief shows the usage of the findKeysWithClue to find a key that has been used to create  2 codes  
/// (this is the same usecase that's in the the main.cpp file)
TEST(CodeAlg, findKeysWithClue_showcase){
